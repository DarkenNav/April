...
namespace April.UI.Implimentations
{
    public class BalloonTip
    {
        ...
        /// <param name="control">элемент управления, на котором будет выводиться оповещение</param>
        /// <param name="icon">– тип иконки оповещения</param>
        /// <param name="timeOut">время отображения оповещения</param>
